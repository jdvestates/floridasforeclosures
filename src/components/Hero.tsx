  ...
  return <section className="bg-primary text-primary-foreground py-20 px-4">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl leading-relaxed opacity-95">We offer foreclosure property lists for all Florida counties. Our lists include owner names, auction dates, listing numbers (if available), mailing addresses, property addresses, market values, judgment values (amount owed), and phone numbers when available. Each county list ranges from $20-$50 monthly subscription, depending on population and data size. Foreclosure lists are sent out on the 2nd of every month.<span className="font-semibold">$20-$50</span> monthly subscription, depending on population and data size. Foreclosure lists are sent out on the 7th of every month.
          </p>
        </div>
      </div>
    </section>;
